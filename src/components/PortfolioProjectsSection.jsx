...
const PortfolioProjectsSection = ({ currentSec }) => {
    const projects = [
        { title: "El Espiral", img: "https://yonychaparro.github.io/Marketing-Digital/Gemini_Generated_Image_t8d6klt8d6klt8d6.png", link: "https://yonychaparro.github.io/Marketing-Digital/index.html", repo: "https://github.com/YonyChaparro/Marketing-Digital", tech: "HTML, CSS, JavaScript" },
        { title: "PosYa!", img: "https://raw.githubusercontent.com/YonyChaparro/YonyChaparroCV/refs/heads/master/img/PosYA1.webp", link: "https://posya.onrender.com/", repo: "https://github.com/YonyChaparro/JavaLi", tech: "TypeScript, React, Express, DIAN" },
        { title: "La casa de las semillas", img: "https://raw.githubusercontent.com/YonyChaparro/YonyChaparroCV/refs/heads/master/img/La%20casa%20de%20las%20semillas1.webp", link: "https://ecommerce-seed-house.vercel.app/", repo: "https://github.com/YonyChaparro/seed-house-components", tech: "React, Bootstrap, Sass" },
    ...
    return (
        <section id="portfolio" className="py-20 px-5 transition-colors duration-500" style={{ backgroundColor: currentSec }}>
